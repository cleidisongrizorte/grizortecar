...
<head>
  ...
  <!-- 
    - custom font link
  -->
  <link rel="stylesheet" href="./static/assets/font/font.css">
         ...
         <li>
          <div class="contact-card">
            ...
            <div>
              ...
              <address class="card-subtitle">Rua 3 Goiania</address>
            </div>
          </div>
        </li>
   ...
   <footer class="footer">
    <div class="container">
      ...
      <div class="footer-bottom">
        ...
        <img src="./static/assets/images/logo_branco.png" width="100" height="63" loading="lazy" alt="grizortecar">
