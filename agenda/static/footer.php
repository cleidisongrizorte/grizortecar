<!-- Footer Start -->
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                                        <a class="text-body mb-2" href="<?= BASE_URL ?>/agenda/index.php?control=login"><i class="fa fa-angle-right text-white mr-2"></i>Entrar</a>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="row mx-n1">
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="<?= BASE_URL ?>/agenda/static/img/gallery-1.jpg" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="<?= BASE_URL ?>/agenda/static/img/gallery-2.jpg" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="<?= BASE_URL ?>/agenda/static/img/gallery-3.jpg" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="<?= BASE_URL ?>/agenda/static/img/gallery-4.jpg" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="<?= BASE_URL ?>/agenda/static/img/gallery-5.jpg" alt=""></a>
                    </div>
                    <div class="col-4 px-1 mb-2">
                        <a href=""><img class="w-100" src="<?= BASE_URL ?>/agenda/static/img/gallery-6.jpg" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
    ...
    <script src="<?= BASE_URL ?>/agenda/static/lib/easing/easing.min.js"></script>
    <script src="<?= BASE_URL ?>/agenda/static/lib/waypoints/waypoints.min.js"></script>
    <script src="<?= BASE_URL ?>/agenda/static/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="<?= BASE_URL ?>/agenda/static/lib/tempusdominus/js/moment.min.js"></script>
    <script src="<?= BASE_URL ?>/agenda/static/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="<?= BASE_URL ?>/agenda/static/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>

    <!-- Template Javascript -->
    <script src="<?= BASE_URL ?>/agenda/static/js/main.js"></script>
</body>
