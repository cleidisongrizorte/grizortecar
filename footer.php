      ...
      <div class="footer-top section">
        <div class="container">
          <div class="footer-brand">
            ...
            <p class="footer-text">
              é uma oficina mecânica especializada na manutenção de veículos nacionais,
          ...
          <ul class="footer-list">
            <li>
              <p class="h3">Nossos Horários</p>
            </li>

            <li>
              <p class="p">Segunda – Sexta</p>

              <span class="span">08:00 – 19:00</span>
            </li>

            <li>
              <p class="p">Sábados e feriados:</p>
            ...
            <li>
              ...
              <span class="span">Não Abrimos</span>
            </li>
          </ul>

          <ul class="footer-list">
            <li>
              <p class="h3">Contato</p>
            </li>
            ...
            <li>
              <a href="tel:+01234567890" class="footer-link">
                ...
                <span class="span">(62) 9999-0000</span>
              </a>
            </li>

            <li>
              <a href="mailto:contato@grizortecar.com.br" class="footer-link">
                <span class="material-symbols-rounded">mail</span>

                <span class="span">contato@grizortecar.com.br</span>
              </a>
            </li>
            ...
            <li>
              <address class="footer-link address">
                ...
                <span class="span"
                  >Rua 75, 46, Central - Goiânia, Goiás</span
                >
              </address>
            </li>
          </ul>
