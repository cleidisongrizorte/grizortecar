...
<head>
  ...
  <!-- 
    - custom font link
  -->
  <link rel="stylesheet" href="./agenda/assets/font/font.css">

  <!-- 
    - preload images
  -->
  <link rel="preload" as="image" href="./agenda/assets/images/loading.svg">
  <link rel="preload" as="image" href="./agenda/assets/images/loading-circle.svg">
  <link rel="preload" as="image" href="./agenda/assets/images/hero-banner.png">
...
<body id="top">
  ...
  <!-- <div class=" preload-box" data-preloader>
    <img src="./agenda/assets/images/loading.svg" width="45" height="45" alt="loading">

    <img src="./agenda/assets/images/loading-circle.svg" width="75" height="75" alt="loading" class="preload-circle">
  </div> -->
  ...
  <!-- <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="./agenda/assets/images/logo.svg" width="160" height="50" alt="volti home">
      </a>
      ...
      <section class="section hero" aria-label="home">
        <div class="container">
          ...
          <figure class="hero-banner" data-reveal="right">
            <img src="./agenda/assets/images/hero-banner.png" width="1116" height="766" alt="Bike" class="w-100">
          </figure>
      ...
      <section class="section about" aria-labelledby="about-label">
        <div class="container">
          ...
          <figure class="about-banner" data-reveal="left">
            <img src="./agenda/assets/images/about-banner-1.jpg" width="380" height="382" loading="lazy" alt="about banner"
              class="w-100 img-1">

            <img src="./agenda/assets/images/about-banner-2.jpg" width="347" height="349" loading="lazy" alt="about banner"
              class="w-100 img-2">
          </figure>
      ...
      <section class="section stats" aria-label="statistics">
        <div class="container">
          ...
          <div class="stats-banner" data-reveal>
            <img src="./agenda/assets/images/stats-banner.jpg" width="1398" height="565" loading="lazy" alt="video banner"
              class="img-cover">
        ...
        <div class="container">
          ...
          <div class="wrapper">
            ...
            <figure class="service-banner img-holder" style="--width: 805; --height: 510;">
              <img src="./agenda/assets/images/service-banner.png" width="805" height="510" loading="lazy" alt="service banner"
                class="img-cover">
            </figure>
      ...
      <section class="cta">
        <div class="container">
          ...
          <figure class="cta-banner" data-reveal="right">
            <img src="./agenda/assets/images/cta-banner.jpg" width="330" height="206" loading="lazy" alt="cta banner"
              class="img-cover">
          </figure>
          ...
          <ul class="blog-list" data-reveal>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner img-holder" style="--width: 770; --height: 550;">
                  <img src="./agenda/assets/images/blog-1.jpg" width="770" height="550" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner img-holder" style="--width: 770; --height: 550;">
                  <img src="./agenda/assets/images/blog-2.jpg" width="770" height="550" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner img-holder" style="--width: 770; --height: 550;">
                  <img src="./agenda/assets/images/blog-3.jpg" width="770" height="550" loading="lazy"
...
<?php include_once 'footer.php'; ?>
  ...
  <!-- 
    - custom js link
  -->
  <script src="./agenda/assets/js/script.js"></script>
